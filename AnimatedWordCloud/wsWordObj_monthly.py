...
class wsWordObj(freetype.Font):
	...
	padding = 40; # The number of pixels around the text of the word YEARLY
	...
	def Draw(self, screen, pos):
		...
		# Add bounds checking to prevent negative or zero sizes
		newSize[0] = max(1, newSize[0])
		newSize[1] = max(1, newSize[1])
