...
class WordSwarm(Framework):
	...
	wordHue = (-1, -1)
	topN = sys.maxsize
	nFrames = 200  # Default number of frames per period
	...
	def __init__(self, argv):
		...
		try:
			...
			print('try:')
			print
			'WordSwarm_black.py -n <topN] -s -t <title> -i <inputfile> -d <outputFolder> -m <maxWordHeight> -c <HexHue1_HexHue2> -b <startDate YYYYMMDD> -e <endDate YYYYMMDD>'
			sys.exit(2)
