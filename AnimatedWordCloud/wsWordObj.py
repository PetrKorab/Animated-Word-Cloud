...
class wsWordObj(freetype.Font):
	...
	padding = 40; # The number of pixels around the text of the word
	...
	def Draw(self, screen, pos):
		...
		newSize = list((0,0))
		newSize[0] = max(1, int(self.boxSize[0] * self.paddedWScale))
		newSize[1] = max(1, int(self.boxSize[1] * self.paddedHScale))
