...
class animated_word_cloud():
    def __init__(self, text, time, date_format, freq, ngram, stopwords, skip):
        self.text = text
        self.time = time
        ...
        output = prep(text_prep=text, time=time, date_format=date_format, ngram=ngram, freq=freq, stopwords=stopwords, skip=skip)
